    ...
    <section class="overflow-hidden rounded-xl border bg-card shadow-xs" id="upload-card">
        ...
        <div class="p-5">
            ...
            <div class="hidden rounded-lg border p-5" id="url-source-wrap">
                <label class="text-sm font-medium" for="database-url">Direct HTTPS download URL</label>
...
function syncSourceButton(){const ready=sourceMode()==='url'?/^https:\/\//i.test($('database-url').value.trim()):!!selectedFile();$('upload-button').disabled=!ready;$('upload-button').textContent=sourceMode()==='url'?'Download and inspect':'Inspect upload';}
